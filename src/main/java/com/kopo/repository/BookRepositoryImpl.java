...
public class BookRepositoryImpl implements BookRepository {
	...
	public BookRepositoryImpl() {
		Book book1 = new Book("1", "해리포터와 마법사의 돌", "8,100", "1.jpg");
		...
		Book book2 = new Book("2", "반지의 제왕", "207,000", "2.jpg");
		...
		Book book3 = new Book("3", "삼국지", "19,800", "3.jpg");
		book3.setAuthor("나관중");
		...
		Book book4 = new Book("4", "언리얼 엔진 5로 만드는 나만의 3D 영화 세트", "45,000", "4.jpg");
		...
		Book book5 = new Book("5", "누구나 할 수 있는 유니티 2D 게임 제작", "26,100", "5.jpg");
